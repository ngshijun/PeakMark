...
const TeacherClassroomsPage = defineAsyncComponent(
  () => import('@/views/TeacherClassroomsPage.vue'),
)
const StudentClassroomsPage = defineAsyncComponent(
  () => import('@/views/StudentClassroomsPage.vue'),
)
