...
const TeacherClassroomSettingsPage = defineAsyncComponent(() => import('@/views/TeacherClassroomSettingsPage.vue'))
const StudentClassroomSettingsPage = defineAsyncComponent(() => import('@/views/StudentClassroomSettingsPage.vue'))
