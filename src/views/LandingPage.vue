...
const features = [
  {
    ...
    description: 'Smart algorithm adapts to your performance, matching you with questions at the right difficulty level',
  },
  {
    icon: Trophy,
    title: 'Progressive Level System',
    description: 'Advance through levels as you master topics, with real-time difficulty adjustment',
  },
  {
    icon: BarChart3,
  ...
  },
  {
    ...
    description: 'Teachers create questions, students practice and improve their skills',
  },
]
</script>
...
<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
    ...
    <section class="container mx-auto px-4 py-20 md:py-32">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" @click="router.push('/register')" class="text-lg px-8 py-6">
            Start Learning Now
          </Button>
          <Button size="lg" variant="outline" @click="router.push('/login')" class="text-lg px-8 py-6">
            Sign In
          </Button>
        </div>
      </div>
    ...
    <section class="container mx-auto px-4 py-16 mb-16">
      <Card class="max-w-4xl mx-auto bg-gradient-to-r from-blue-600 to-purple-600 border-0 text-white">
        <CardContent class="py-12 px-8 text-center">
          <h3 class="text-3xl md:text-4xl font-bold mb-4">Ready to Start Your Journey?</h3>
          <p class="text-lg md:text-xl mb-8 text-blue-50">
            Join PeakMark today and unlock your full potential
          </p>
          <Button size="lg" variant="secondary" @click="router.push('/register')" class="text-lg px-8 py-6">
            Create Your Account
          </Button>
        </CardContent>
      </Card>
